...
func _init() -> void:
	...
	assert(RuntimeDebugger.ambiguity_requires_owned_termination(7, 8, 42))
	assert(not RuntimeDebugger.ambiguity_requires_owned_termination(7, 7, 42))
	assert(not RuntimeDebugger.ambiguity_requires_owned_termination(7, 8, 0))
